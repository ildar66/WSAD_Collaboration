...
public class DetailsAction extends Action {
	...
	public ActionForward perform(
		...
		if (((DetailsForm) actionForm).getBill() != null) {
			request.setAttribute("bill", ((DetailsForm) actionForm).getBill());
		}
		if (((DetailsForm) actionForm).getComments() != null) {
			request.setAttribute(
				"comments",
				((DetailsForm) actionForm).getComments());
		}
		return forward;
	}
