...
public class SearchByCityJavaBean {
	...
	public SearchByCityJavaBean() {
		super();
		initialize();
	}

	public void initialize() {
		_$state = new String("SearchByCityOK");
	}
	...
	public void execute() {
		try {
			...
			Peopledab.executeReadByFieldForAction_5(getLocation());
