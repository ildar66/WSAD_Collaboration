...
public final class MailTemplateFactory {
    ...
    public static InputStream findTemplate(MailTemplate template) {
        ...
        return MailTemplateFactory.findTemplate(templateName.toString());
    }

    public static InputStream findTemplate(String templateName) {
        SecuritySupport ss = SecuritySupport.getInstance();
        InputStream is = null;

        // First try the Context ClassLoader
        ClassLoader cl = MailTemplateFactory.findClassLoader();
