...
<html:form action="/SearchCriteriaAction" target="_top">
	<table border="0">
		<tr>
			...
			{
				WhitePages0.PeopleObject obj = (WhitePages0.PeopleObject)formListlast_name.get(i);
         ...
         for (int j = 0; j < alast_name.size() - 1; j++) {
            for (int i = 0; i < alast_name.size() - 1; i++) {
				 WhitePages0.PeopleObject first = (WhitePages0.PeopleObject)alast_name.elementAt(i);
				 WhitePages0.PeopleObject second = (WhitePages0.PeopleObject)alast_name.elementAt(i + 1);
			...
			{
				WhitePages0.PeopleObject obj = (WhitePages0.PeopleObject)formListcity.get(i);
         ...
         for (int j = 0; j < acity.size() - 1; j++) {
            for (int i = 0; i < acity.size() - 1; i++) {
				 WhitePages0.PeopleObject first = (WhitePages0.PeopleObject)acity.elementAt(i);
				 WhitePages0.PeopleObject second = (WhitePages0.PeopleObject)acity.elementAt(i + 1);
			...
			{
				WhitePages0.PeopleObject obj = (WhitePages0.PeopleObject)formListemail_address.get(i);
         ...
         for (int j = 0; j < aemail_address.size() - 1; j++) {
            for (int i = 0; i < aemail_address.size() - 1; i++) {
				 WhitePages0.PeopleObject first = (WhitePages0.PeopleObject)aemail_address.elementAt(i);
				 WhitePages0.PeopleObject second = (WhitePages0.PeopleObject)aemail_address.elementAt(i + 1);
...
<html:form action="/SearchContentAction" target="_top">
	...
	<tr>
			...
			<th  align="left">
  			<bean:message key="WhitePages.Search.SearchContent.Email"/>
			</th>
			<th  align="left">
  			<bean:message key="WhitePages.Search.SearchContent.Faxnumber"/>
			</th>
			<th  align="left">
  			<bean:message key="WhitePages.Search.SearchContent.Phonenumber"/>
			</th>
	</tr>
		<logic:iterate id="SearchContentAction" name="PeopleSearchContentList">
			...
			<td align="left">
				<bean:write name="SearchContentAction" property="email" filter="true"/>
			</td>
			<td align="left">
				<bean:write name="SearchContentAction" property="faxnumber" filter="true"/>
			</td>
			<td align="left">
				<bean:write name="SearchContentAction" property="phonenumber" filter="true"/>
			</td>
