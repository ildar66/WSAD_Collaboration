...
public class SearchByLastNameAction extends Action {
	...
	public ActionForward perform(
		...
		SearchByLastNameJavaBean bean = new SearchByLastNameJavaBean();
		...
		if (_$state.equals("SearchByLastNameOK")) {
			try {
