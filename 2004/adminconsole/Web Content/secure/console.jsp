...
<html:html locale="true">
  <HEAD>
    <title>WebSphere Administrative Console</title>
...
<frameset rows="<%= framesize %>,*" FRAMEBORDER="YES" BORDER="2" BORDERCOLOR="#000000">
  ...
  <frame name="header" title='<bean:message key="header.frame" />' scrolling="NO" noresize src="<%=request.getContextPath() + "/secure/" %>banner.jsp" marginwidth="0" marginheight="0" >
