...
<%@ page language="java" import="com.ibm.ws.console.core.form.AbstractDetailForm,org.apache.regexp.*,org.apache.struts.util.MessageResources,org.apache.struts.action.Action"%>
...
%>
	...
	String addbutton = messages.getMessage(request.getLocale(),"button.add");
        ...
        int islogon = priorpage.indexOf("/admin/secure/logon.do");
        int islogoff = priorpage.indexOf("/admin/secure/logoff.do");
