...
%>
      <table width="100%" border="0" cellspacing="0" cellpadding="2">
        <tr> 
          <td class="table-text"> 
		    <html:checkbox property="outRotateOnSize" styleId="acheckbox1" disabled="<%=val%>"/>
        ...
        <tr> 
          <td class="complex-property"> 
		    ...
		    <html:text property="outMaximumFileSize" size="10" styleId="atextfield" disabled="<%=val%>"/>
      		<bean:message key="JVMLogs.maxSize.MB"/> 
          </td>
		</tr>
		<tr> 
          <td class="table-text"> 
		    <html:checkbox property="outRotateOnTime" styleId="acheckbox2" disabled="<%=val%>"/>
		...
		<tr> 
          <td class="complex-property"> 
		    ...
		    <html:text property="outStartTime" size="10" styleId="atextfield" disabled="<%=val%>"/>
          </td>
		</tr>
		<tr>
		  <td class="complex-property">
            <bean:message key="JVMLogs.time.repeatTime"/>
		    <html:text property="outRepeatTime" size="10" styleId="atextfield" disabled="<%=val%>"/>
