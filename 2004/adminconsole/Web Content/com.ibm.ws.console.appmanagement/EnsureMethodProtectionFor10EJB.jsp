...
<%@ page language="java" import="com.ibm.websphere.management.application.client.*, com.ibm.ws.console.appmanagement.form.*"%>
...
<%
	 ...
	 String yesString = appM.getMessage("AppDeploymentOption.Yes");
...
<%	} else {%>
  ...
  <tr>
    ...
    <td class="table-text" >
       <html:multibox property="checkBoxes" value="<%=Integer.toString(i)%>" /> Deny All
    </td>
  </tr>
