...
%>
  ...
  <tr>
    ...
    <th class="column-head-name" scope="col"><%= (String)column3[i]%> 
    </th>
  ...
  <html:hidden property="column5" value="<%= (String)column5[i]%>" />
    <th class="column-head-name" scope="col"><%= (String)column6[i]%> </th>
  <html:hidden property="column6" value="<%= (String)column6[i]%>"/>
  </tr>
<%
		} else {
%>
  <tr>
    ...
    <td class="table-text" >
     ...
     <td class="table-text" >
	      <html:select property="column6"  value="<%=(String)column6[i]%>">
                <html:option value="<%=containerValue%>" >
			        <%= container %>
			    </html:option>
                <html:option value="<%=perConnFactoryValue %>" >
