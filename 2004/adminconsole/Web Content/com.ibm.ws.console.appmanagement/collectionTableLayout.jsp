...
<A target="statuswindow" href="/admin/AppManagementStatus?text=true&name=<%=name%>"><IMG name="statusIcon" border="0" SRC="/admin/AppManagementStatus?name=<%=name%>" ALT="<bean:message key="click.for.status"/>"></A>
