...
<table border="0" cellpadding="3" cellspacing="1" width="100%" summary="List table">
        <tr>
          <td class="wizard-step-text"> 
            <html:radio property="protection" value="uncheck"/>
			<bean:message key="appinstall.uncheck"/>
			<BR>
            <html:radio property="protection" value="exclude" />
			<bean:message key="appinstall.exclude"/>
			<BR>
            <html:radio property="protection" value="role"/>
