...
<table border="0" cellpadding="3" cellspacing="1" width="100%" summary="List table">
      <tr>
          <td class="wizard-step-text"><bean:message key="appinstall.virtual.host"/>
            <html:select property="selectedItem">
              <bean:define id="globalForm" name="globalForm" scope="session" type="GlobalForm"/>
			  <logic:iterate id="virtualHost" name="globalForm" property="virtualHosts">
...
%>
  ...
  <html:hidden property="column2" value="<%= (String)column2[i]%>"/>
  </tr>
...
<%	}  else {%>
  ...
  <tr>
     ...
     <td class="table-text" headers="header1">
	      <html:select property="column2" value="<%=(String)column2[i]%>" >
              <bean:define id="globalForm" name="globalForm" scope="session" type="GlobalForm"/>
			  <logic:iterate id="virtualHost" name="globalForm" property="virtualHosts">
                <html:option value="<%= (String) virtualHost %>" >
			        <%= (String) virtualHost %>
