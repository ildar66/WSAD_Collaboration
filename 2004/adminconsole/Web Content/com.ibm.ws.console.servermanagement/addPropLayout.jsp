...
<table border="0" cellpadding="2" cellspacing="1" width="100%" summary="Properties Table" class="framing-table">
        ...
        <% String link = "";
            if ( item.getLink().indexOf("resourceUri=") != -1 ) {
                link = item.getLink() + "&parentRefId=" + refId + "&serverRefId=" + serverRefId + "&contextId=" + contextId + "&perspective=" + perspective ;
            } else {
                link = item.getLink() + "&resourceUri=" + resourceUri + "&parentRefId=" + refId + "&serverRefId=" + serverRefId + "&contextId=" + contextId + "&perspective=" + perspective ;
            }%> 
