...
<%    
    ...
    <html:radio property="routing" value="domain" disabled="<%=val%>">
...
function changeServers(theform) {
        ...
        if (theform.messageBrokerDomainName.options.selectedIndex == z) {
                    ...
                    var repslen = thereps.length - 1;
                                //alert(theform.preferredLocalDRSBrokerName.options.length);

                    theform.preferredLocalDRSBrokerName.options.length = repslen;                    
                    
                                repslen = theform.preferredLocalDRSBrokerName.options.length;
                                //alert(repslen);
                                
            for (i=0;i<repslen;i++) {
                theform.preferredLocalDRSBrokerName.options[i].text = thereps[i+1];
                theform.preferredLocalDRSBrokerName.options[i].value = thereps[i+1];
            }
        }
