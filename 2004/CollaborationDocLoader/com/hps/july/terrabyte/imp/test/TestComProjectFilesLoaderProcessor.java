...
import com.hps.july.terrabyte.imp.command.ComProjectCommand;
 ...
 * Time: 17:07:10
 */
public class TestComProjectFilesLoaderProcessor {
    ...
    public void test() {
            ...
            try {
                con = getConnection();
                ComProjectCommand command = new ComProjectCommand(new Integer(345), con, log);
                TerrabyteLoaderProcessor.executeLoaderCommand(command, "nri-application.vimpelcom.ru", new Integer(80));
                //TerrabyteLoaderProcessor.executeLoaderCommand(command, "nri-database.vimpelcom.ru", new Integer(80));
...
*/
    ...
    public static void main(String[] args) {
        TestComProjectFilesLoaderProcessor test = new TestComProjectFilesLoaderProcessor();
        test.test();
