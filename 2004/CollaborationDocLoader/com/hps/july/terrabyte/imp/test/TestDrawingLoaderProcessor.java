 ...
 * Time: 17:07:10
 */
public class TestDrawingLoaderProcessor {
	...
	public void test() {
			...
			try {
				con = getConnection();
				DrawingCommand command = new DrawingCommand(new Integer(345), con, log);
				command.setDirectory("O:\\Чертежи");
				command.setCatalog("Чертежи");
...
*/
	...
	public static void main(String[] args) {
		TestDrawingLoaderProcessor test = new TestDrawingLoaderProcessor();
		test.test();
