 ...
 * Time: 17:07:10
 */
public class TestWayMapLoaderProcessor {
	...
	public void test() {
			...
			try {
				con = getConnection();
				con = getConnection();
				MapWaysLoadCommand command = new MapWaysLoadCommand(new Integer(345), con, con);
				command.setDirectory("C:\\5");
				command.setCatalog(null);
...
*/
	...
	public static void main(String[] args) {
		TestWayMapLoaderProcessor test = new TestWayMapLoaderProcessor();
		test.test();
