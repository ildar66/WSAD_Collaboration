...
import com.hps.july.terrabyte.imp.command.terrabyte.TerrabyteTransferCommand;
 ...
 * Time: 17:07:10
 */
public class TestTerrabyteTransformProcessor {
...
*/
				...
				TerrabyteTransferCommand command = new TerrabyteTransferCommand(new Integer(2222), con, log);
...
*/
	...
	public static void main(String[] args) {
		TestTerrabyteTransformProcessor test = new TestTerrabyteTransformProcessor();
		test.test();
