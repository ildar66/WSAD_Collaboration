 ...
 * Time: 17:07:10
 */
public class TestImageLoaderProcessor {
    ...
    public void test() {
            ...
            try {
                con = getConnection();
                LoadPositionGRPImageCommand command = new LoadPositionGRPImageCommand(new Integer(345), con, con);
                command.setDirectory("C:\\6");
                command.setCatalog("TEstMap");
                TerrabyteLoaderProcessor.executeLoaderCommand(command, "localhost", new Integer(8080));
...
*/
            ...
            connection = DriverManager.getConnection("jdbc:informix-sqli://172.21.9.137:1541:informixserver=infdata;database=july;DB_LOCALE=ru_RU.1251;CLIENT_LOCALE=ru_RU.1251;user=vad;password=AKpASCSX");
    ...
    public static void main(String[] args) {
        TestImageLoaderProcessor test = new TestImageLoaderProcessor();
        test.test();
