 ...
 * Time: 17:07:10
 */
public class TestRRLRequestAndPermitProcessor {
	...
	public void test() {
			...
			try {
				...
				RRLRequestAndPermitCommand command = new RRLRequestAndPermitCommand(new Integer(2223), con, log);
				command.setParameter(CommandNames.FILE_CATALOG, "C:\\Project\\AnalysisBS\\Частотное_обеспечение_РРЛ\\");
...
*/
			...
			if(i == 2) connection = DriverManager.getConnection("jdbc:informix-sqli://172.21.9.138:1541:informixserver=beeinf;database=july;DB_LOCALE=ru_RU.1251;CLIENT_LOCALE=ru_RU.1251;user=informix;password=djkr04;informixLockModeWait=60");
	...
	public static void main(String[] args) {
		TestRRLRequestAndPermitProcessor test = new TestRRLRequestAndPermitProcessor();
		test.test();
