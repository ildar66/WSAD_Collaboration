...
public class testSLDProcessor {
	...
	public void test() {
			...
			try {
				con = getConnection();
				SLDCommand command = new SLDCommand(new Integer(345), con, log);
				command.setParameter(CommandNames.OBJECT_TYPE, "prjbs");
				command.setParameter(CommandNames.FILE_CATALOG, "Сдача БС в эксплуатацию");
...
*/
	...
	public static void main(String[] args) {
		testSLDProcessor test = new testSLDProcessor();
		test.test();
