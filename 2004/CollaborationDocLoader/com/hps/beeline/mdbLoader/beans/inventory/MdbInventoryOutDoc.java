 ...
 */
public class MdbInventoryOutDoc implements LoadableBean{
    ...
    public String getAvia_bag_flag() {
        return avia_bag_flag;
    }
    ...
    public void storeInDb() throws BaseException {
        MdbInventoryHelper.getInstance().insertOutDoc(this);
    }
}
