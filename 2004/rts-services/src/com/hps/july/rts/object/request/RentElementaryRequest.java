 ...
 */
public class RentElementaryRequest extends AbstractRequest implements Request {

    private ElementaryRequest elementaryRequest;

    public RentElementaryRequest() {
    }
...
//
     ...
     * @return
     */
    public ElementaryRequest getElementaryRequest() {
        return elementaryRequest;
    }

    /**
     * @param request
     */
    public void setElementaryRequest(ElementaryRequest request) {
        elementaryRequest = request;
    }



// Из ElementaryRequest
...
//	  }
	...
	public int compareTo(Object o) {
		if (o == null || !(o instanceof RentElementaryRequest)) {
			throw new ClassCastException("The object is not instance of RentElementaryRequest.");
		}
		RentElementaryRequest request = (RentElementaryRequest) o;
		int lastCmp = 0;
		if(getNumber()!=null && request.getNumber()!=null) {
			...
			throw new NullPointerException("The number of RentElementaryRequest is null.");
		}
		return lastCmp;
	}
