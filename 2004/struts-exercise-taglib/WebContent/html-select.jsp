...
<TABLE style="font-size: 8pt;border-spacing:1in;border-color:  black;">
	<TBODY>
		<TR>
			<TD></TD>
			<TD><A style="text-decoration: none;"></TD>
		</TR>
		<TR>
			<TD><html:radio property="isDateModified" value="true"></TD>
			<TD><html:radio property="isDateModified" value="false"></TD>
		</TR>
	</TBODY>
</TABLE></html:html>
