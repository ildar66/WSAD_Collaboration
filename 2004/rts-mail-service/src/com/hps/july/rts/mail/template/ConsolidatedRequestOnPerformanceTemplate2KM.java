 ...
 * 10.03.2006
 */
public class ConsolidatedRequestOnPerformanceTemplate2KM extends ConsolidatedRequestOnPerformanceTemplate {

    public ConsolidatedRequestOnPerformanceTemplate2KM() {
        super();
    }
    public ConsolidatedRequestOnPerformanceTemplate2KM(ConsolidatedRequest request) {
        super(request);
    }

    public ConsolidatedRequestOnPerformanceTemplate2KM(ConsolidatedRequest request, Collection visaPersonList) {
        super(request, visaPersonList);
    }

    public ConsolidatedRequestOnPerformanceTemplate2KM(ConsolidatedRequest request, Collection visaPersonList, String host) {
