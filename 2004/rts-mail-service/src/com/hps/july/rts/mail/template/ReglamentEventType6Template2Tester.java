/*
 *  $Id: ReglamentEventType6Template2Tester.java,v 1.1 2007/05/02 08:25:50 vglushkov Exp $
...
/**
 * Темплейт письма для события 6
 * Тестирующего, Руководителя, КМ
 * ежедневно о необходимости тестирования
 * Консолидированной заявки
 * (начиная с третьего рабочего дня после прихода заявки)
 * Subject: Заявка ТС  не оттестирована в течении ...
 * To: 	КМ
 * @author <a href="mailto:vadim.glushkov@sntru.com">Vadim Glushkov</a>
 * @version $Revision: 1.1 $ $Date: 2007/05/02 08:25:50 $
 */
public class ReglamentEventType6Template2Tester extends RTSMailTemplate {

	private long delay;
	protected ConsolidatedRequest request;
	protected StringBuffer reference;

	public ReglamentEventType6Template2Tester(ConsolidatedRequest request, long createTime, String host) {
	...
	public String getSubject() {
		...
		msg.append(" не оттестирована в течении ");
		msg.append(delay);
		msg.append(".");
		return msg.toString();
	}
