/*
 *  $Id: ConsolidatedRequestOnPerformanceTemplate2RM.java,v 1.4 2007/04/15 16:54:50 vglushkov Exp $
 ...
 */
public class ConsolidatedRequestOnPerformanceTemplate2RM extends ConsolidatedRequestOnPerformanceTemplate {

    public ConsolidatedRequestOnPerformanceTemplate2RM() {
        super();
    }
    public ConsolidatedRequestOnPerformanceTemplate2RM(ConsolidatedRequest request) {
        super(request);
    }

    public ConsolidatedRequestOnPerformanceTemplate2RM(ConsolidatedRequest request, Collection visaPersonList) {
        super(request, visaPersonList);
    }

    public ConsolidatedRequestOnPerformanceTemplate2RM(ConsolidatedRequest request, Collection visaPersonList, String host) {
