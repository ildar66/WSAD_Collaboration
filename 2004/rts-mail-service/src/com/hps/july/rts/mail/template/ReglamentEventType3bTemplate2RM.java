/*
 *  $Id: ReglamentEventType3bTemplate2RM.java,v 1.1 2007/04/29 17:22:05 vglushkov Exp $
 ...
 * Subject: Заявка ТС  не завизирована  исполнителем (заявка на арендованую часть)  в течении ...
 * To: 	КМ
 * @author <a href="mailto:vadim.glushkov@sntru.com">Vadim Glushkov</a>
 * @version $Revision: 1.1 $ $Date: 2007/04/29 17:22:05 $
 */
public class ReglamentEventType3bTemplate2RM extends RTSMailTemplate {
	...
	public ReglamentEventType3bTemplate2RM(ElementaryRequest request, ConsolidatedRequest cRequest, long createTime, String host) {
		this.request = request;
		this.cRequest = cRequest;
		delay = (int)((System.currentTimeMillis() - createTime)/(1000L * 60L * 60L * 24L));
		this.reference = new StringBuffer(host);
		this.reference.append("/rts/ConsolidatedRequestsListAction.do?navclear=1&currentRole=RM&itemMenu=item1_17_5_8&isNumber=on&number=").append(cRequest.getNumber());
	}
	...
	public List getTo() {
		...
		Person person = cRequest.getRegMan();
	...
	public String getSubject() {
		...
		msg.append(" не завизирована  исполнителем (заявка на арендованую часть)  в течении ");
		msg.append(delay);
		msg.append(".");
		return msg.toString();
	}
