/*
 *  $Id: ConsolidatedRequestOnRevisionTemplate2KM.java,v 1.4 2007/04/15 16:54:50 vglushkov Exp $
 ...
 */
public class ConsolidatedRequestOnRevisionTemplate2KM extends ConsolidatedRequestOnRevisionTemplate {

    public ConsolidatedRequestOnRevisionTemplate2KM() {
        super();
    }
    public ConsolidatedRequestOnRevisionTemplate2KM(ConsolidatedRequest request) {
        super(request);
    }

    public ConsolidatedRequestOnRevisionTemplate2KM(ConsolidatedRequest request, Collection mailPersonList) {
        super(request, mailPersonList);
    }

    public ConsolidatedRequestOnRevisionTemplate2KM(ConsolidatedRequest request, Collection mailPersonList, String host) {
        super(request, mailPersonList);
