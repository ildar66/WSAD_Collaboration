 ...
 * 10.03.2006
 */
public class ConsolidatedRequestOnVisaTemplate2KM extends ConsolidatedRequestOnVisaTemplate {

    public ConsolidatedRequestOnVisaTemplate2KM(ConsolidatedRequest request, Collection visaPersonList, String host) {
...
//        if(person == null) 
//        	throw new IllegalArgumentException("visa Key Manager must be defined");
    }
