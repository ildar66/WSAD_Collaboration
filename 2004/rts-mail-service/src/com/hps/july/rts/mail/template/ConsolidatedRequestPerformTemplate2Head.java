/*
 *  $Id: ConsolidatedRequestPerformTemplate2Head.java,v 1.2 2007/04/14 16:41:42 vglushkov Exp $
 ...
 */
public class ConsolidatedRequestPerformTemplate2Head extends ConsolidatedRequestPerformTemplate {

    public ConsolidatedRequestPerformTemplate2Head() {
        super();
    }
    public ConsolidatedRequestPerformTemplate2Head(ConsolidatedRequest request) {
        super(request);
    }

    public ConsolidatedRequestPerformTemplate2Head(ConsolidatedRequest request, Collection mailPersonList) {
        super(request, mailPersonList);
    }

    public ConsolidatedRequestPerformTemplate2Head(ConsolidatedRequest request, Collection mailPersonList, String host) {
